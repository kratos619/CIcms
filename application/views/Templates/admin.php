                ...
                <br>
                    <ul class="list-group">
                        <li class="list-group-item">
                            <a href="<?php echo base_url() ?>admin/pages/add">Add New Page</a>
                        </li>
                        <li class="list-group-item">
                            <a href="<?php echo base_url() ?>admin/subjects/add">Add New Subject</a>
                        </li>
                        <li class="list-group-item">
                            <a href="<?php echo base_url() ?>admin/users/add">Add New Users</a>
                        </li>
